...
public class MyLog {
    ...
    private static final String MYLOG_PATH_SDCARD_DIR = "/sdcard/kantu/log";// 日志文件在sdcard中的路径
    ...
    private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件
        ...
        String PATH_LOGCAT = MyApplication.getContext().getFilesDir().getAbsolutePath()
                + File.separator + "llvisionLog";

//        File dirsFile = new File(MYLOG_PATH_SDCARD_DIR);
        File dirsFile = new File(PATH_LOGCAT);
        if (!dirsFile.exists()) {
            dirsFile.mkdirs();
        }
        //Log.i("创建文件","创建文件");
